...
describe('ContentCollectionDirect', async () => {
  ...
  test('direct-load-content_collection', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-content_collection', setup.live)) return
