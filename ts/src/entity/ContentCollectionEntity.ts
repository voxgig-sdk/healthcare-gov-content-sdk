...
class ContentCollectionEntity extends HealthcareGovContentEntityBase<ContentCollection> {
  ...
  constructor(client: HealthcareGovContentSDK, entopts: any) {
    ...
    this.name = 'content_collection'
    this.name_ = 'content_collection'
    this.Name = 'ContentCollection'
  }


  make(this: ContentCollectionEntity) {
    return new ContentCollectionEntity(this._client, this.entopts())
  }
