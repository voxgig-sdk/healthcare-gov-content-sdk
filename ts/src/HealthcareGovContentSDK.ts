...
class HealthcareGovContentSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new HealthcareGovContentSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return HealthcareGovContentSDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'HealthcareGovContent' }
  }

  toString() {
    return 'HealthcareGovContent ' + this._utility.struct.jsonify(this.toJSON())
  }
...
const SDK = HealthcareGovContentSDK
...
export {
  ...
  BaseFeature,
  HealthcareGovContentEntityBase,
