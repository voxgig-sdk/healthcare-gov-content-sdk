...
class ContentCollectionDirectTest extends TestCase
{
    public function test_direct_load_content_collection(): void
    {
        $setup = content_collection_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-content_collection", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
