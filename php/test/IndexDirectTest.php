...
class IndexDirectTest extends TestCase
{
    public function test_direct_list_index(): void
    {
        $setup = index_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-index", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
