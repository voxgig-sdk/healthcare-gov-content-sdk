...
// HealthcareGovContent SDK feature test
//
...
class FtCtrl extends HealthcareGovContentControl
{
...
class FtClient
{
    ...
    private HealthcareGovContentUtility $utility;

    public function __construct(HealthcareGovContentUtility $utility, array $options)
    {
    ...
    public function get_utility(): HealthcareGovContentUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (HealthcareGovContentContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public HealthcareGovContentContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (HealthcareGovContentContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = HealthcareGovContentConfig::make_feature($name);
    ...
    private static function buildUrl(HealthcareGovContentSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof HealthcareGovContentError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new HealthcareGovContentResponse($fetched);
        }
    ...
    private function fail(HealthcareGovContentContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (HealthcareGovContentContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
