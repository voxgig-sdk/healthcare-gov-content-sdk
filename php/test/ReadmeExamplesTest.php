...
// HealthcareGovContent SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HealthcareGovContentSDK::test)
...
{
    private const SDK_CLASS = 'HealthcareGovContentSDK';
    ...
    private const SDK_BASE = 'healthcaregovcontent_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../healthcaregovcontent_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
