...
// HealthcareGovContent SDK Index entity
...
class IndexEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IndexEntity($this->_client, $opts);
    }

    /**
     * @param Index|array $args Index data (assoc-array) to store.
     */
    ...
    /**
     * @return Index|array The current Index data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Index fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Index fields).
     */
    ...
    /**
     * List Index items matching the given filter.
     *
     * @param IndexListMatch|array|null $reqmatch Match filter (any subset
     *   of Index fields) as an assoc-array; IndexListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Index[]|array A list of Index items as assoc-arrays at
