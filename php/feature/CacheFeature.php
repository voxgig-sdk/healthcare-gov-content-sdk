...
// HealthcareGovContent SDK cache feature
...
class HealthcareGovContentCacheFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _through(HealthcareGovContentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
