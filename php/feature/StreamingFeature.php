...
// HealthcareGovContent SDK streaming feature
...
class HealthcareGovContentStreamingFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _iterate(HealthcareGovContentResult $result): \Generator
    {
    ...
    private function _streamable(HealthcareGovContentContext $ctx): bool
    {
