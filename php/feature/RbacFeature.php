...
// HealthcareGovContent SDK rbac feature
...
class HealthcareGovContentRbacFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _required(HealthcareGovContentContext $ctx): ?string
    {
    ...
    private function _reject(HealthcareGovContentContext $ctx, string $required): void
    {
    ...
    private function _track(HealthcareGovContentContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
