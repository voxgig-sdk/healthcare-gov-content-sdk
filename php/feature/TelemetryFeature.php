...
// HealthcareGovContent SDK telemetry feature
...
class HealthcareGovContentTelemetryFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _close(HealthcareGovContentContext $ctx, bool $ok): void
    {
