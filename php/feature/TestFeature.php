...
// HealthcareGovContent SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HealthcareGovContentTestFeature extends HealthcareGovContentBaseFeature
{
    ...
    public function init(HealthcareGovContentContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HealthcareGovContentContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HealthcareGovContentParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HealthcareGovContentContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HealthcareGovContentContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = HealthcareGovContentParam::call($ctx, $k);
