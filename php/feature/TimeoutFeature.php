...
// HealthcareGovContent SDK timeout feature
...
class HealthcareGovContentTimeoutFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _with_timeout(HealthcareGovContentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HealthcareGovContentContext $_ctx, float $ms): void
    {
        $client = $this->client;
