...
// HealthcareGovContent SDK ratelimit feature
...
class HealthcareGovContentRatelimitFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _acquire(HealthcareGovContentContext $ctx): void
    {
    ...
    private function _track(HealthcareGovContentContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
