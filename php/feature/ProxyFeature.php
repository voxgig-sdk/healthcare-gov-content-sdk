...
// HealthcareGovContent SDK proxy feature
...
class HealthcareGovContentProxyFeature extends HealthcareGovContentBaseFeature
{
    ...
    public function init(HealthcareGovContentContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HealthcareGovContentContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
