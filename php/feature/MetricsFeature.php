...
// HealthcareGovContent SDK metrics feature
...
class HealthcareGovContentMetricsFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _record(HealthcareGovContentContext $ctx, bool $ok): void
    {
