...
// HealthcareGovContent SDK audit feature
...
class HealthcareGovContentAuditFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _emit(HealthcareGovContentContext $ctx, string $outcome): void
    {
