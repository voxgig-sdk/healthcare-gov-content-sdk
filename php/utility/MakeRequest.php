...
// HealthcareGovContent SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HealthcareGovContentMakeRequest
{
    public static function call(HealthcareGovContentContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HealthcareGovContentResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HealthcareGovContentResponse($fetched);
        } else {
