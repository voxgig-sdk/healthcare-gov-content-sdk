...
// HealthcareGovContent SDK utility: result_basic

class HealthcareGovContentResultBasic
{
    public static function call(HealthcareGovContentContext $ctx): ?HealthcareGovContentResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HealthcareGovContentError) ? $result->err->msg : (string)$result->err;
