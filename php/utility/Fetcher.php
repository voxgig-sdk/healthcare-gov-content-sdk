...
// HealthcareGovContent SDK utility: fetcher

class HealthcareGovContentFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HealthcareGovContentSDK/1.0)';
    ...
    public static function call(HealthcareGovContentContext $ctx, string $fullurl, array $fetchdef): array
    {
