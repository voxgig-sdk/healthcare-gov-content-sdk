...
from core.operation import HealthcareGovContentOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return HealthcareGovContentError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except HealthcareGovContentError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = HealthcareGovContentResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = HealthcareGovContentSDK.test(None, None)
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(HealthcareGovContentBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = HealthcareGovContentSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = HealthcareGovContentSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = HealthcareGovContentSpec({
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = HealthcareGovContentSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = HealthcareGovContentSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = HealthcareGovContentOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = HealthcareGovContentSDK.test(None, setup_opts)
