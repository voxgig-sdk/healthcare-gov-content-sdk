# HealthcareGovContent SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HealthcareGovContentSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HealthcareGovContentSDK(...) and HealthcareGovContentSDK.test(...) become
#      HealthcareGovContentSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "healthcaregovcontent_sdk"
_SDK_CLASS = "HealthcareGovContentSDK"
