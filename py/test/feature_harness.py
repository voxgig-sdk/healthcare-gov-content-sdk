# HealthcareGovContent SDK feature test harness
#
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else HealthcareGovContentControl()
        self.meta = {}
        self.op = op
        self.entity = entity
        self.spec = None
...
class Harness:
    ...
    def _populate_result(self, ctx, response, fetch_err):
        result = HealthcareGovContentResult({})
        ctx.result = result
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=HealthcareGovContentControl(ctrl or {}))
