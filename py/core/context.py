...
class HealthcareGovContentContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HealthcareGovContentControl()
        ...
        if isinstance(sp, HealthcareGovContentSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HealthcareGovContentResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HealthcareGovContentResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HealthcareGovContentOperation({})
        ...
        op = HealthcareGovContentOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return HealthcareGovContentError(code, msg, self)
