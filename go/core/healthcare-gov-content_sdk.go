...
type HealthcareGovContentSDK struct {
	Mode     string
...
func (sdk *HealthcareGovContentSDK) OptionsMap() map[string]any {
...
func (sdk *HealthcareGovContentSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HealthcareGovContentSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HealthcareGovContentSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HealthcareGovContentSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HealthcareGovContentSDK {
	...
	sdk := NewHealthcareGovContentSDK(sdkopts)
	sdk.Mode = "test"
