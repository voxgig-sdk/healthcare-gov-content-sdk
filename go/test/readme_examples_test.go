...
const testSeed = `map[string]any{"entity": map[string]any{"content_collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "post_title": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
