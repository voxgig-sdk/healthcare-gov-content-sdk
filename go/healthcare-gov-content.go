...
// instead of `sdk.NewHealthcareGovContentSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HealthcareGovContentSDK  { return NewHealthcareGovContentSDK(nil) }
func Test() *HealthcareGovContentSDK { return TestSDK(nil, nil) }
