// Command HealthcareGovContent-mcp is an MCP server exposing the HealthcareGovContent
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HealthcareGovContent_list  — list records of an entity
//	HealthcareGovContent_load  — load a single record of an entity
//
