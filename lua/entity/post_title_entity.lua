...
local PostTitleEntity = {}
PostTitleEntity.__index = PostTitleEntity


function PostTitleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PostTitleEntity)
  self._name = "post_title"
  self._client = client
...
function PostTitleEntity:get_name()
  return self._name
end


function PostTitleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PostTitleEntity.new(self._client, opts)
end


function PostTitleEntity:data_set(args)
  if args ~= nil then
...
function PostTitleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PostTitleEntity:match_set(args)
  if args ~= nil then
...
function PostTitleEntity:match_get()
...
function PostTitleEntity:stream(action, args, callopts)
...
function PostTitleEntity:_run_op(ctx, post_done)
  local utility = self._utility
