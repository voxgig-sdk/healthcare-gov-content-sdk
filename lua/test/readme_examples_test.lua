...
local SDK_MODULE = "healthcare-gov-content_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["content_collection"] = { ["test01"] = { id = "test01" } }, ["index"] = { ["test01"] = { id = "test01" } }, ["post_title"] = { ["test01"] = { id = "test01" } } } }'
