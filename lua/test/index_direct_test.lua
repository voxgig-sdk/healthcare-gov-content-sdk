...
describe("IndexDirect", function()
  it("should direct-list-index", function()
    local setup = index_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-index", setup.live and "live" or "unit")
...
function index_direct_setup(mockres)
