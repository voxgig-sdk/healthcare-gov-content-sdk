...
describe("ContentCollectionDirect", function()
  it("should direct-load-content_collection", function()
    local setup = content_collection_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-content_collection", setup.live and "live" or "unit")
...
function content_collection_direct_setup(mockres)
