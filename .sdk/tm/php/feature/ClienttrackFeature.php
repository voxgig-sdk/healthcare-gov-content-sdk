...
// HealthcareGovContent SDK clienttrack feature
...
class HealthcareGovContentClienttrackFeature extends HealthcareGovContentBaseFeature
{
    ...
    public function PostConstruct(HealthcareGovContentContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HealthcareGovContent-SDK';
