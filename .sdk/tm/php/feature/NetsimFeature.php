...
// HealthcareGovContent SDK netsim feature
...
class HealthcareGovContentNetsimFeature extends HealthcareGovContentBaseFeature
{
    ...
    private function _simulate(HealthcareGovContentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HealthcareGovContentContext $ctx, array $applied): void
    {
        $client = $this->client;
