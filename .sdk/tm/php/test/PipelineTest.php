...
// HealthcareGovContent SDK pipeline test
//
...
{
    private static function utility(): HealthcareGovContentUtility
    {
        return new HealthcareGovContentUtility();
    }
    ...
    private static function ctx(array $over = []): HealthcareGovContentContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HealthcareGovContentContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HealthcareGovContentOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HealthcareGovContentError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HealthcareGovContentOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HealthcareGovContentMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HealthcareGovContentOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HealthcareGovContentMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HealthcareGovContentOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HealthcareGovContentMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HealthcareGovContentSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HealthcareGovContentMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HealthcareGovContentResponse([]),
            'result' => new HealthcareGovContentResult([]),
        ]);
        [, $err] = HealthcareGovContentMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec([]),
            'response' => null,
            'result' => new HealthcareGovContentResult([]),
        ]);
        [, $err] = HealthcareGovContentMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec(['step' => 's']),
            'response' => new HealthcareGovContentResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HealthcareGovContentResult([]),
        ]);
        [, $err] = HealthcareGovContentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec(['step' => 's']),
            'response' => new HealthcareGovContentResponse(self::resp(200, ['v' => 1])),
            'result' => new HealthcareGovContentResult([]),
        ]);
        [, $err] = HealthcareGovContentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec(['step' => 's']),
            'response' => new HealthcareGovContentResponse(self::resp(200, ['v' => 2])),
            'result' => new HealthcareGovContentResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HealthcareGovContentMakeResponse::call($ctx);
    ...
    {
        $preset = new HealthcareGovContentResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec([]),
            'response' => new HealthcareGovContentResponse([]),
            'result' => new HealthcareGovContentResult([]),
        ...
        [$got, $err] = HealthcareGovContentMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HealthcareGovContentResult([])]);
        [, $err] = HealthcareGovContentMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HealthcareGovContentSpec([]), 'result' => null]);
        [, $err] = HealthcareGovContentMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HealthcareGovContentSpec(['step' => 's']),
            'result' => new HealthcareGovContentResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HealthcareGovContentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HealthcareGovContentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HealthcareGovContentSpec(['step' => 's']),
            'result' => new HealthcareGovContentResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HealthcareGovContentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HealthcareGovContentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HealthcareGovContentResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HealthcareGovContentSpec([]),
            'result' => new HealthcareGovContentResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HealthcareGovContentMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HealthcareGovContentMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HealthcareGovContentError('boom', 'boom');
        $utility->fetcher = function (HealthcareGovContentContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HealthcareGovContentSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HealthcareGovContentMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HealthcareGovContentContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HealthcareGovContentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HealthcareGovContentResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HealthcareGovContentMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HealthcareGovContentContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HealthcareGovContentSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HealthcareGovContentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HealthcareGovContentResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HealthcareGovContentSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HealthcareGovContentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HealthcareGovContentMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HealthcareGovContentMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HealthcareGovContentResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HealthcareGovContentDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HealthcareGovContentResult(['ok' => false])]);
        $this->expectException(HealthcareGovContentError::class);
        HealthcareGovContentDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HealthcareGovContentResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HealthcareGovContentMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HealthcareGovContentMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HealthcareGovContentBaseFeature();
        $b = new HealthcareGovContentBaseFeature();
        HealthcareGovContentFeatureAdd::call($ctx, $a);
        HealthcareGovContentFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HealthcareGovContentBaseFeature
    {
        $f = new HealthcareGovContentBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HealthcareGovContentFeatureAdd::call($ctx, self::named_feature('a'));
        HealthcareGovContentFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HealthcareGovContentFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HealthcareGovContentFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HealthcareGovContentFeatureAdd::call($ctx, $replace);
        ...
        HealthcareGovContentFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HealthcareGovContentContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HealthcareGovContentSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HealthcareGovContentPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HealthcareGovContentPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HealthcareGovContentResponse(['headers' => null]),
            'result' => new HealthcareGovContentResult([]),
        ]);
        HealthcareGovContentResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HealthcareGovContentResultBody::call($ctx);
