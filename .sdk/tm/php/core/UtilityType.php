...
// HealthcareGovContent SDK utility type

class HealthcareGovContentUtility
{
    ...
    public static function copy(HealthcareGovContentUtility $src): HealthcareGovContentUtility
    {
        $u = new HealthcareGovContentUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
