...
#      offline in seeded test mode (HealthcareGovContentSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HealthcareGovContent_sdk.rb")
  SDK_CLASS = "HealthcareGovContentSDK"
  ...
  SDK_BASE = "HealthcareGovContent_sdk"
