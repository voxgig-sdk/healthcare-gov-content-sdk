...
class IndexEntity
  ...
  # @return [Index, Hash] the current Index data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Index fields)
  def match_get
  ...
  #
  # @param reqmatch [IndexListMatch, Hash, nil] match filter (any subset of
  #   Index fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Index>, Array] the matching Index items; raises HealthcareGovContentError on failure
