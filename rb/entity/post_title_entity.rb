...
class PostTitleEntity
  ...
  def make
    opts = @_entopts.dup
    PostTitleEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [PostTitleListMatch, Hash, nil] match filter (any subset of
  #   PostTitle fields); defaults to nil, treated as an empty match that lists all.
