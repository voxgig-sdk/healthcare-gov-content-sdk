// Command HealthcareGovContent-cli is a CLI + REPL for the HealthcareGovContent SDK,
...
const prompt = "healthcare-gov-content"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "content_collection index post_title"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      HEALTHCARE_GOV_CONTENT_APIKEY (api key), HEALTHCARE_GOV_CONTENT_BASE (base url override)")
