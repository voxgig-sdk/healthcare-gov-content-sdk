...
func registerSDKWords(r *eng.Registry, client *sdk.HealthcareGovContentSDK) {
...
func runOp(client *sdk.HealthcareGovContentSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
